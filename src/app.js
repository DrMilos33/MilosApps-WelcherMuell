...
const DATA_PATHS = {
  items: "/MilosApps-WelcherMuell/public/data/waste-items.v1.json",
  sources: "/MilosApps-WelcherMuell/public/data/sources.v1.json",
  regions: "/MilosApps-WelcherMuell/public/data/regions.v1.json"
};
...
async function initialize() {
  ...
  if ("serviceWorker" in navigator) {
    try {
      await navigator.serviceWorker.register("/MilosApps-WelcherMuell/sw.js");
    } catch (error) {
